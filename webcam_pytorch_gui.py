...
class WebcamPredictor:
    ...
    def load_model(self):
        ...
        try:
            model_path = "/home/nvidia10/runs/classify/train3/weights/best.pt"
            ...
            labels_file = "/home/nvidia10/datasets/lettersdatabase2/labels.txt"
    ...
    def start_camera(self):
        """Start the camera"""
        try:
            self.cap = cv2.VideoCapture(1)  # Using camera index 1 as specified
...
<body>
    ...
    print("🔥 Using PyTorch model: /home/nvidia10/runs/classify/train3/weights/best.pt")
